...
export default function AdminPayments() {
  ...
  const fetchAgentPendingAmounts = async () => {
    ...
    try {
      ...
      // For each agent, calculate pending amount
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2 flex items-center gap-2">
            ...
            Agent Payments & Pending Amounts
          </h1>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <p className="text-3xl font-bold text-orange-600">₹{stats.totalPending.toLocaleString()}</p>
              </div>
            </CardContent>
          </Card>
        </div>
